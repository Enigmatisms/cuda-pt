...
public:
    ...
    // Borrowed from Tungsten: Computes hemispherical integral of dielectricReflectance(ior, cos(theta))*cos(theta)
    // This is a Monte-Carlo integration
    static CPT_CPU_GPU_INLINE float diffuse_fresnel(float ior, const int sample_cnt = 131072) {
    ...
    static CPT_CPU_GPU_INLINE float fresnel_simple(float eta, float cos_theta_i) {
