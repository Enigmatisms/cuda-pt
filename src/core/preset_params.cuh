...
inline constexpr std::array<const char *, NumMetalType> METAL_NAMES = {
    "Au",  "Cr", "Cu",  "Ag", "Al",  "W",  "TiO2", "Ni",
    "MgO", "Na", "SiC", "V",  "CuO", "Hg", "Ir"};
...
inline constexpr std::array<const char *, DispersionType::NumDispersionType>
    DISPERSION_NAMES = {"Diamond",     "DiamondHigh", "Silica",   "Glass_BK7",
                        "Glass_BaF10", "Glass_SF10",  "Sapphire", "Water"};
